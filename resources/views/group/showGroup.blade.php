    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">معلومات : <strong> <u class="text-success">{{ $groupData->name }}</strong></u></h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="card card-info card-outline">
                            ...
                            <!-- Card Body with Form -->
                            <form method="POST" enctype="multipart/form-data" action="/group/{{ $groupData->id }}"
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="name" spellcheck="false"
                                                autocomplete="one-time-code" name="name" value="{{ $groupData->name }}"
                                                required>
                                            @error('name')
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                ...
                                                <div class="dropzone p-5 border border-dashed text-center" id="dropzone">
                                                    ...
                                                    <img id="preview" class="mt-3 img-fluid  " width="200"
                                                        src="{{ asset('storage/' . $groupData->image) }}" height="200"
                                ...
                                <div class="card-footer ">
                                    <div class=" col-md-2 col-sm-12 ">
                                        <button class="btn btn-primary w-100" type="submit">تعديل المجموعة</button>
                                    </div>
                                </div>
                            </form>
                        </div>
